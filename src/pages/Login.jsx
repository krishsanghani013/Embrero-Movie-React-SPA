            ...
            <main className="pt-20 text-center bg-[#080808] min-h-screen">
                <main className="grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                    ...
                    <div
                        ...
                        {/* left   */}
                        <div
                            className="bg-[#151515] rounded-2xl border border-[#2A2A2A] shadow-[0_16px_40px_rgba(0,0,0,0.5)] p-8 sm:p-10 w-full max-w-md mx-auto">
                            <div className="text-center mb-8">
                                <div
                                    className="inline-flex w-12 h-12 bg-[#FF6B351A] text-[#FF6B35] rounded-2xl items-center justify-center mb-4 shadow-[0_2px_8px_rgba(255,107,53,0.2)]">
                            ...
                            <form onsubmit="event.preventDefault(); window.location.href='index.html';" className="space-y-5">
                                <div>
                                    ...
                                    <input type="email" id="email" required placeholder="user@example.com"
                                        className="w-full bg-[#1C1C1C] border rounded-[10px] px-4 py-3 text-sm placeholder-[#71717A] transition-all duration-250ms ease-[ease] focus:outline-none focus:border-[#FF6B35] focus:ring-4 focus:ring-[#FF6B35]/15 shadow-sm" />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="password" id="password" required placeholder="••••••••"
                                        className="w-full bg-[#1C1C1C] border foucs:border-[#3A3A3A] rounded-[10px] px-4 py-3 text-sm  placeholder-[#71717A] transition-all duration-250ms ease-[ease] focus:outline-none focus:border-[#FF6B35] focus:ring-4 focus:ring-[#FF6B35]/15 shadow-sm" />
                                </div>

                                <button type="submit"
                                    className="w-full  hover:bg-[#E85D04] active:bg-[#C2410C] text-white font-bold py-3.5 px-4 rounded-[10px] transition-all duration-250ms ease-[ease] shadow-[0_8px_24px_rgba(255,107,53,0.25)] hover:shadow-[0_20px_50px_rgba(255,107,53,0.35)] hover:-translate-y-0.5 active:translate-y-0 mt-2">
                            ...
                            <div className="mt-6 grid grid-cols-2 gap-4">
                                <button
                                    className="flex items-center justify-center gap-2 bg-[#1C1C1C] border border-[#3A3A3A] hover:border-[#FF6B35] hover:bg-[#242424] text-[#D4D4D8] font-semibold py-2.5 px-4 rounded-[10px] transition-all duration-250 ease-[ease] shadow-[0_2px_8px_rgba(0,0,0,0.3)]">
                        ...
                        {/* right */}
                        <div
                            className="hidden lg:block bg-[#151515]/60 backdrop-blur-md rounded-2xl border border-[#2A2A2A] shadow-[0_8px_24px_rgba(0,0,0,0.4)] p-8 h-fit animate-slide-up">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    <div
                                        className="w-10 h-10 rounded-[10px] bg-[#FF6B351A] text-[#FF6B35] flex items-center justify-center shrink-0">
                                ...
                                <div className="flex items-start gap-4">
                                    <div
                                        className="w-10 h-10 rounded-[10px] bg-[#FFB0001A] text-[#FFB000] flex items-center justify-center shrink-0">
                                ...
                                <div className="flex items-start gap-4">
                                    <div
                                        className="w-10 h-10 rounded-[10px] bg-[#22C55E]/10 text-[#22C55E] flex items-center justify-center shrink-0">
                                ...
                                <div className="flex items-start gap-4">
                                    <div
                                        className="w-10 h-10 rounded-[10px] bg-[#C1121F1A] text-[#C1121F] flex items-center justify-center shrink-0">
